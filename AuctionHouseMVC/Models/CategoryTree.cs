...
namespace AuctionHouseMVC.Models
{
    ...
    {
        public static CategoryTree<T> CategoryTree<T>(this HtmlHelper html, IEnumerable<T> items)
        {
            return new CategoryTree<T>(html, items);
        }
    }
    public class CategoryTree<T> : IHtmlString
    {
            ...
            public CategoryTree(HtmlHelper html, IEnumerable<T> items)
            {
            ...
            public CategoryTree<T> ItemText(Func<T,string> selector)
            {
            ...
            public CategoryTree<T> ItemTemplate(Func<T,HelperResult> itemTemplate)
            {
            ...
            public CategoryTree<T> Children(Func<T, IEnumerable<T>> selector)
            {
                //  if (selector == null) //throw new ArgumentNullException("selector");  
            ...
            public CategoryTree<T> EmptyContent(string emptyContent)
            {
            ...
            public CategoryTree<T> HtmlAttributes(object htmlAttributes)
            {
        ...
        /// </summary>  
        public CategoryTree<T> HtmlAttributes(IDictionary<string, object> htmlAttributes)
        {
        ...
        /// </summary>  
        public CategoryTree<T> ChildrenHtmlAttributes(object htmlAttributes)
            {
            ...
            /// HTML attributes appended to the children items  
            /// </summary>  
            public CategoryTree<T> ChildrenHtmlAttributes(IDictionary<string, object> htmlAttributes)
            {
                if (htmlAttributes == null) throw new ArgumentNullException("htmlAttributes");
